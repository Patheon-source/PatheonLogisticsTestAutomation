...
public class GENXolair_Utilities {

	static Properties list = new Properties();
	private static Logger log=LogManager.getLogger(GENXolair_Utilities.class.getName());
	...
	
	{
		...
		Date rd=new SimpleDateFormat("MM/dd/yyyy").parse(ExcelObj.getCellData("GENXolair_OrderAPI", TestCaseName, "requestDate"));
		SimpleDateFormat RequestDateFormat = new SimpleDateFormat("yyyy-MM-dd");
		String RequestDate = RequestDateFormat.format(rd);
		OrderData.put("professionalDesignation", ExcelObj.getCellData("GENXolair_OrderAPI", TestCaseName, "ProfessionalDesignation"));
		OrderData.put("lastName", ExcelObj.getCellData("GENXolair_OrderAPI", TestCaseName, "LastName"));
		OrderData.put("zipCode", ExcelObj.getCellData("GENXolair_OrderAPI", TestCaseName, "ShipZipCode")+ExcelObj.getCellData("GENXolair_OrderAPI", TestCaseName, "ShipZipCode4"));
		OrderData.put("reference9", ExcelObj.getCellData("GENXolair_OrderAPI", TestCaseName, "CPROFID"));
		OrderData.put("street3", ExcelObj.getCellData("GENXolair_OrderAPI", TestCaseName, "ShipAddress3"));
		OrderData.put("city", ExcelObj.getCellData("GENXolair_OrderAPI", TestCaseName, "ShipCity"));
		OrderData.put("imageData", ExcelObj.getCellData("GENXolair_OrderAPI", TestCaseName, "SRFImage"));
		OrderData.put("firstName", ExcelObj.getCellData("GENXolair_OrderAPI", TestCaseName, "FirstName"));
		OrderData.put("customersPractitionerId", ExcelObj.getCellData("GENXolair_OrderAPI", TestCaseName, "MDMID"));
		OrderData.put("signatureFlag", "0");
		OrderData.put("requestDate", RequestDate+" 00:00:00.0");
		OrderData.put("street1", ExcelObj.getCellData("GENXolair_OrderAPI", TestCaseName, "ShipAddress1"));
		OrderData.put("street2", ExcelObj.getCellData("GENXolair_OrderAPI", TestCaseName, "ShipAddress2"));
		OrderData.put("state", ExcelObj.getCellData("GENXolair_OrderAPI", TestCaseName, "ShipState"));
		OrderData.put("customerOrderNo", ExcelObj.getCellData("GENXolair_OrderAPI", TestCaseName, "OrderNumber"));
	...
	public static Boolean validateDBOrderData(String orderNumber, String TestCaseName, String PDD)
	{
		...
		try {
			ExpectedData = GENXolair_Utilities.OrderDataExpected(TestCaseName, PDD);
	...
	public static String getResultMessage(String TestCaseName) throws Exception
	{
		String TestDataExcelPath= System.getProperty("user.dir")+"//TestData//TestData.xlsx";
		dataDrivenFromExcel ExcelObj = new dataDrivenFromExcel(TestDataExcelPath);
		return ExcelObj.getCellData("GENXolair_OrderAPI", TestCaseName, "resultMessage");
	}
}